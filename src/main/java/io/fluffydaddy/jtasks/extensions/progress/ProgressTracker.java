...
import io.fluffydaddy.jutils.MessageFormatter;
		...
		return new ProgressListener() {
			...
			public void onProgressChanged(double progressAmount, long amountLength, double speedAmount, double readedLength)
			{
				try
				{
					...
					String totalStr = MessageFormatter.formatSize(totalAmount);
					
					String speedStr = MessageFormatter.formatSize(speedAmount);
					String limitStr = MessageFormatter.formatSize(amountLength);
					String countStr = MessageFormatter.formatSize(readedLength);
